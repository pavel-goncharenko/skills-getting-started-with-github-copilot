              ...
              .map(
                (participant) => `
                  <li>
                    ...
                    <button class="remove-participant" type="button" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}" aria-label="Remove ${participant}" title="Remove participant">&#10005;</button>
                  </li>`
              )
              .join("")}</ul>`
